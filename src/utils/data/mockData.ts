export const recommendData = [
  {
    ...
    title: "연말 맞이 회고",
    content:
      "벌써 2023년의 마지막 날이네요. 다들 어떤 한 해 보내셨나요? 의식적으로 회고하지 않으면 순간의 생각이나 느낀 점을 흘려 보내게 되는 것 같아서 회고에 높은 우선순위를 두고 있는데요, 해가 넘어가기 전에 연말회고 글을 올릴 수 있어서 나름 뿌듯한 마무리가 될 것 같습니다. (마지막 날까지 미뤄질 줄은 정말 몰랐네요 😅) 올해는 제가 처음으로 1년을 꽉 채워 일한 해이자, 첫 창업을 그만두고 첫 직장을 다니기 시작한 해라 유난히 밀도있었던 것 같아요. 그만큼 감사한 분들도 많고, 생각나는 순간들도 많은 것 같습니다. 아래에 올해 제가 배우고 느꼈던 것들 중심으로 1년의 소회를 한 번 정리해 봤어요! 올 한 해 저를 지켜봐주신 모든 분들께 감사드리고, 내년에도 잘 부탁드립니다 🙇‍♀️",
    reviewId: 0,
